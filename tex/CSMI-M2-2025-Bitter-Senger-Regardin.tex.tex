...
To model the temperature distribution in the bitter we use the well known heat equation:
$$
...
\noindent We use the following Poisson equation for electric potential:
$$
...
formulation).
And a \textbf{time scheme} is then applied to solve the problem in time.
