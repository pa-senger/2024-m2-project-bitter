...
\begin{figure}[H]
  ...
  \caption{View of the mesh coloured in function of the heat field, with the vector field representing electric field orientation, coloured in function of electric field magnitude.}
\end{figure}
